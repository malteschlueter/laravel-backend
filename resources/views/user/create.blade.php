                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="post" action="{{ route('backend.user.store') }}">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="name" id="name" placeholder="@lang('backend::user.create.name.placeholder')" value="{{ old('name') }}">
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="email" id="email" placeholder="@lang('backend::user.create.email.placeholder')" value="{{ old('email') }}">
